...
TOOLS = [
    ...
    },
    {
        ...
        "description": (
            ...
            "才用這個工具清掉它；有效的選擇不要清掉。"
            "你自己口頭更正一筆先前建立的檢定時也要呼叫這個工具：如果你告訴玩家某筆已建立的檢定"
            "技能/數值用錯了、要重新擲，必須同時呼叫這個工具把舊的清掉，再用正確參數重新呼叫 "
            "skill_check／sanity_check 建立新的——不能只在敘述裡說『這筆不算』卻留著舊的待處理檢定，"
            "否則玩家之後 /coc check 會擲到你已經說不算的那一筆。"
