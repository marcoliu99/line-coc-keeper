...
def _entries(lifecycle_kp_only: bool | None = None) -> list[HelpEntry]:
    ...
    return [
        ...
        HelpEntry(("scenario", "template", "status"), "scenario", "查看中文模板", "查看背景處理、版本與待核對項目。", ("/coc scenario template status 劇本ID",), kp_only=True, command=("scenario", "template", "status")),
        HelpEntry(("scenario", "template", "preview"), "scenario", "預覽中文模板", "將模板的 KP 校對預覽傳送私訊。", ("/coc scenario template preview 劇本ID 模板版本",), kp_only=True, command=("scenario", "template", "preview")),
        HelpEntry(("scenario", "template", "approve"), "scenario", "核准中文模板", "檢查來源與規則後核准模板供 RAG 使用。", ("/coc scenario template approve 劇本ID 模板版本",), kp_only=True, command=("scenario", "template", "approve")),
        HelpEntry(("scenario", "template", "import"), "scenario", "匯入中文模板", "從 IMPORT_DIR 匯入校對後的 Markdown 模板。", ("/coc scenario template import 劇本ID 檔名.md",), kp_only=True, command=("scenario", "template", "import")),
